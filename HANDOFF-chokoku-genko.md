...
最終更新: 2026-08-31　**chokoku-genko.html = v4.3**／**index_b.html = v1.9.414**
...
| v4.3 | 拓本を重ねるを「並べて」へ。ゴムシートは出力の下見と文字位置だけに |
