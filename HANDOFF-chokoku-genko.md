...
最終更新: 2026-08-31　**chokoku-genko.html = v4.0**／**index_b.html = v1.9.414**
...
| v3.9 | 「並べて」に拓本側の線（頭／脚・センター・文字の長さ）。選んだガイドラインの分だけ出す |
| v4.0 | 「並べて」で線をつかんで動かす。ゴムシートの「文字の位置」をガイドラインごとに |
